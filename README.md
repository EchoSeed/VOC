...
Dual-Register Extraction — Technical + plain language concept identification
Triple-Mode Elaboration — Decision logic, analogies, operational insights
Semantic Taxonomy — Term clustering, density analysis, importance scoring
Compress/Expand — Core thesis + glossary generation
Meta-Analysis — Blind spots, emergence assessment, self-critique
Skill Forge — Actionable SKILL.md with code, patterns, and workflows
...
Error Elimination Mastery — 605 lines, 49.2KB. Seed: "A skill isn't built from correctness. It's built from the systematic removal of incorrectness."
PopperFLUX — 607 lines, 56.3KB. Three-pass refinement of Popperian falsificationism with recursive self-critique integration.
AI Code Risk Assessment — 708 lines, 54.3KB. Stroustrup's critique formalized into production-grade risk framework.
Metric Colonization Analysis — 252 lines, 39.2KB. Critical theory synthesis with zero code (shows range).
